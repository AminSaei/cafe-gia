...
function applyTheme(theme) {
  ...
  // Keep menu permanently black/gold for this theme preview.
  root.style.setProperty("--menu-soft-1", "#181818");
  root.style.setProperty("--menu-soft-2", "#0f0f0f");
  root.style.setProperty("--menu-border", "#6d5432");
  root.style.setProperty("--menu-tint", "#d4aa63");
  root.style.setProperty("--menu-glow", "#3a2d18");
  root.style.setProperty("--accent-2", "#e3c187");
}
